---
title: "Evidence Caching for Specialist Service Results"
sidebarTitle: "Evidence Caching"
description: "thcode caches immutable sealed evidence from AI for Thai service calls. Cached results preserve original consent provenance and avoid redundant service invocations."
---
...
The `CacheIndex` exposes four operations:
