---
title: "AI for Thai Credentials and Service Access"
...
<Steps>
  ...
  <Step title="Secret-free reference stored">
    ...
    interface AiForThaiCredentialReference {
      referenceId: string;         // e.g. "aiforthai-2026-07-12T..."
      credentialRevision: string;  // changes on rotation
      fingerprint: string;         // hash of identity + host + revision
      storedAt: string;            // UTC ISO-8601
    }
    ```
