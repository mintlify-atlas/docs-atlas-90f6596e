...
description: "thcode's three permission profiles control when actions execute automatically versus asking for approval. Profiles are orthogonal to Work Mode and session-scoped."
---
