---
title: "thcode Slash Command Grammar and Exit Code Reference"
sidebarTitle: "Overview"
description: "All 14 frozen slash commands, their aliases, approval requirements, and shell-expansion blocking rules for the thcode terminal agent."
---
...
<CardGroup cols={2}>
  ...
  <Card title="provider-deletion-lifecycle" icon="trash">
