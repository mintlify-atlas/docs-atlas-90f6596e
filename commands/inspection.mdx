---
title: "Inspection Commands: Status, Permissions, Activity, Context"
sidebarTitle: "Inspection"
description: "Read-only thcode commands for session state, permissions, provider health, tool catalog, activity history, and context utilization."
---
